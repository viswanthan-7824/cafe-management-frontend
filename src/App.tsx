...
export function App() {
  ...
  // 1. UNAUTHENTICATED EMAIL + OTP LOGIN VIEW
  if (!user) {
    return (
      <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #fff7ed 0%, #f8fafc 50%, #ffedd5 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1.5rem 1rem' }}>
        <div className="glass-card animate-fade-in" style={{ width: '100%', maxWidth: '440px', padding: '2.5rem 2rem', borderRadius: '24px', background: 'rgba(255, 255, 255, 0.95)', border: '1px solid #fed7aa', boxShadow: '0 20px 50px rgba(234, 88, 12, 0.12)' }}>
          {/* Header Branding */}
          <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
            <div style={{ width: '56px', height: '56px', borderRadius: '18px', background: 'linear-gradient(135deg, #ea580c 0%, #c2410c 100%)', color: '#ffffff', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 20px rgba(234, 88, 12, 0.3)', marginBottom: '0.75rem' }}>
              <Coffee size={30} />
            </div>
            <h1 style={{ fontSize: '1.6rem', fontWeight: 900, color: '#0f172a', margin: 0, letterSpacing: '-0.02em' }}>
              SAEC CAFÉ
            </h1>
            <p style={{ fontSize: '0.82rem', fontWeight: 700, color: '#ea580c', margin: '0.2rem 0 0 0', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
          ...
          {loginError && (
            <div style={{ background: '#fef2f2', border: '1px solid #fecaca', color: '#991b1b', padding: '0.75rem 1rem', borderRadius: '12px', fontSize: '0.85rem', fontWeight: 600, marginBottom: '1.25rem', display: 'flex', alignItems: 'flex-start', gap: '0.6rem' }}>
            ...
            <>
              <div style={{ marginBottom: '1.5rem' }}>
                ...
                <p style={{ fontSize: '0.85rem', color: '#64748b', margin: 0, lineHeight: 1.4 }}>
                  Enter your approved college email address to receive a secure one-time login code.
                </p>
              </div>
              ...
              <form onSubmit={handleRequestCode} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                <button
                  ...
                  style={{ width: '100%', height: '48px', fontSize: '1rem', fontWeight: 800, borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', boxShadow: '0 4px 14px rgba(234, 88, 12, 0.35)' }}
                >
                  {isSubmitting ? <RefreshCw size={20} className="animate-spin" /> : null}
                  {isSubmitting ? 'Checking Approval...' : 'CONTINUE'}
                </button>
              </form>

              <div style={{ marginTop: '1.5rem', textAlign: 'center', borderTop: '1px solid #f1f5f9', paddingTop: '1.25rem' }}>
                <p style={{ fontSize: '0.78rem', color: '#64748b', margin: '0 0 0.5rem', lineHeight: 1.4 }}>
                  Use your approved college email to receive a secure one-time login code.
                </p>
                <button
                  type="button"
                ...
                {cantAccessHelp && (
                  <div style={{ marginTop: '0.85rem', background: '#fff7ed', border: '1px solid #fed7aa', borderRadius: '10px', padding: '0.85rem', fontSize: '0.8rem', color: '#9a3412', textAlign: 'left', lineHeight: 1.4 }}>
                    <strong>Account Pre-Approval Notice:</strong><br />
                    Students and Faculty accounts are created by Admin via Excel imports. If your email is not registered yet, please request the canteen administrator to upload your class roster.
                  </div>
                )}
              </div>
            </>
          ...
          {authStep === 'CODE' && (
            <>
              ...
              <form onSubmit={handleVerifyCode} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                <div>
                  ...
                  <input
                    ...
                    className="input-field"
                    style={{ width: '100%', height: '54px', fontSize: '1.6rem', fontWeight: 900, textAlign: 'center', letterSpacing: '0.6rem', background: '#f8fafc', border: '2px solid #ea580c', borderRadius: '14px', color: '#0f172a' }}
                  />
                </div>
              ...
              <div style={{ marginTop: '1.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.85rem', borderTop: '1px solid #f1f5f9', paddingTop: '1.25rem' }}>
                <button
                  type="button"
          ...
          <div style={{ marginTop: '2rem', fontSize: '0.72rem', color: '#94a3b8', textAlign: 'center' }}>
